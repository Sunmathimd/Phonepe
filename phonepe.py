...
st.set_page_config(page_title= "Phonepe Pulse Visualization | By Sunmathi M D",
                   ...
                   menu_items={'About': """# This dashboard app is created by *Sunmahti*!"""})
...
with st.sidebar:
    selected = option_menu("Menu", ["Home","Top Charts","Explore Data","About"], 
                ...
                default_index=0,
                styles={"nav-link": {"font-size": "20px", "text-align": "left", "margin": "-2px", "--hover-color": "#b24dff"},
                        "nav-link-selected": {"background-color": "#b24dff"}})
